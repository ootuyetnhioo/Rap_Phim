            ...
            <div class="row">
                <div class="justify-content-center col-md-12">
                    <div class="jumbotron bg-white">
                        <h2 class="text-uppercase font-weight-bold">phim sắp chiếu</h2>
                    </div>
