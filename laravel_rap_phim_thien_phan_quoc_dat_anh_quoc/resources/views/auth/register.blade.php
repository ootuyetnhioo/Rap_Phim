            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-0 my-4 mx-3">
                        ...
                        <div class="form-floating mb-3">
                            <input type="email" name="rolename" class="form-control" id="floatingInput" placeholder="name@example.com">
                            <label for="floatingInput">Rolename</label>
                        </div>
                        ...
                        <p class="text-center mb-0">Already have an Account? <a href="http://127.0.0.1:8000/login">Login</a></p>
                    </div>
                </div>
            </div>
        </div>
